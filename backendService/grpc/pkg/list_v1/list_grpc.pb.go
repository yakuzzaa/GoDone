...
type ListV1Client interface {
	...
	GetDetail(ctx context.Context, in *GetListRequest, opts ...grpc.CallOption) (*DetailResponse, error)
...
func (c *listV1Client) GetDetail(ctx context.Context, in *GetListRequest, opts ...grpc.CallOption) (*DetailResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type ListV1Server interface {
	...
	GetDetail(context.Context, *GetListRequest) (*DetailResponse, error)
...
func (UnimplementedListV1Server) GetDetail(context.Context, *GetListRequest) (*DetailResponse, error) {
...
func _ListV1_GetDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ListV1Server).GetDetail(ctx, req.(*GetListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
